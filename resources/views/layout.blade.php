...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('js/jquery.min.js') }}js/jquery.min.js"></script>
            ...
            <div class="container">
                ...
                <div class="navigation">
                     <span class="menu"></span> 
                        <ul class="navig">
                            <li><a href="{{url('/')}}"  class="active">Trang Chủ</a></li>
                ...
                <form method="get" action="{{url('tim-kiem')}}">
                    ...
                    <div class="header-right">
                        <div class="search-bar">
                            <input type="text" name="keyworkds" value="" placeholder="Tìm Kiếm">
            ...
            <div class="container">
                ...
                <ul id="flexiselDemo3">
                    ...
                    <li>
                        <a href="#">
                            <div class="banner-1">
                                <img src="{{ asset('mages/s-3.jpg"') }} class="img-responsive" alt="">
                            </div>
                        </a>
                    </li>		
                    <li>
